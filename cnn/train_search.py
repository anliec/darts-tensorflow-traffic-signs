...
from cnn.model_search import *
# from cnn.data_utils import read_data
from cnn.data_utils_signs import read_data
...
def compute_unrolled_step(x_train, y_train, x_valid, y_valid, w_var, train_loss, lr):
    ...
    _, unrolled_train_loss = Model(x_train, y_train, True, args.init_channels, CLASS_NUM, args.layers,
                                   name="unrolled_model")
